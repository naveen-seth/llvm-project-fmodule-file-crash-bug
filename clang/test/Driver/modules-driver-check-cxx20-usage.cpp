...
//--- only-global.cpp
// RUN: %clang -std=c++20 -fmodules-driver -Rmodules-driver \
...
// RUN: %clang -std=c++23 -fmodules-driver -Rmodules-driver \
...
// RUN: not %clang -std=c++20 -fmodules-driver -Rmodules-driver \
