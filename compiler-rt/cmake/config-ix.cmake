...
if(APPLE)
    ...
    foreach(platform ${DARWIN_EMBEDDED_PLATFORMS})
      if(DARWIN_${platform}sim_SYSROOT)
        ...
        if(DARWIN_${platform}sim_ARCHS)
          ...
          list(APPEND TSAN_DD_SUPPORTED_OS ${platform}sim)
      ...
      if(DARWIN_${platform}_SYSROOT)
        ...
        if(DARWIN_${platform}_ARCHS)
          ...
          if(DARWIN_${platform}_TSAN_ARCHS)
            ...
            list(APPEND TSAN_DD_SUPPORTED_OS ${platform})
          endif()
  ...
  list_intersect(TSAN_SUPPORTED_ARCH
    ...
    SANITIZER_COMMON_SUPPORTED_ARCH)
  list_intersect(TSAN_DD_SUPPORTED_ARCH
    ALL_TSAN_DD_SUPPORTED_ARCH
    SANITIZER_COMMON_SUPPORTED_ARCH)
  ...
  filter_available_targets(TSAN_DD_SUPPORTED_ARCH ${ALL_TSAN_DD_SUPPORTED_ARCH})
...
set(ALL_SANITIZERS asan;rtsan;dfsan;msan;hwasan;tsan;tsan_dd;tysan;safestack;cfi;scudo_standalone;ubsan_minimal;gwp_asan;nsan;asan_abi)
...
set(COMPILER_RT_HAS_TSAN_DD ${COMPILER_RT_HAS_TSAN})
